...
- success palette color (#0A1C0F) for tool success background
- error palette color (#1C050E) for tool error background

### Changed

- toolSuccessBg now uses success color instead of panel
- toolErrorBg now uses error color instead of panel
...
[0.3.0]: https://github.com/dkmnx/pi-cursor-theme/compare/v0.2.0...v0.3.0
